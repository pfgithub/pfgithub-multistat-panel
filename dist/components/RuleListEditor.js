        ...
        return (react_1.default.createElement(ui_1.PanelOptionsGroup, { title: "Styles" },
            react_1.default.createElement(react_1.default.Fragment, null,
                    ...
                    return (react_1.default.createElement("div", { key: i },
                        ...
                        react_1.default.createElement(RuleEditor_1.RuleEditor, { key: i, rule: rule, getVariables: function () { return _this.props.getVariables(); }, onChange: function (newRule) {
                                ...
                                _this.props.onChange(_this.props.rules.filter(function (currentRule) {
                                    return currentRule === rule ? false : true;
                                }));
                            }, onDuplicate: function () {
                                _this.props.onChange(_this.props.rules.concat([__assign({}, rule)]));
                            } })));
                }),
                ...
                react_1.default.createElement(ui_1.Button, { onClick: function () {
                        _this.props.onChange(_this.props.rules.concat([types_1.defaultMultistatRule]));
                    } }, "Add Rule"))));
    };
